...
eval(fs.readFileSync(path.join(__dirname, '..', 'ui.js'), 'utf8') + '\n' + code);
window.scrollTo = () => {};
...
for(const [name,make] of screens){
 const variants=name==='exercise'?['progress','equipment','targets']:name==='history'?['summary','exercises','body','diary']:name==='settings'?['','session','appearance','data','help','gyms']:name==='gym'?['plates','bars','dumbbells','machines']:[''];
