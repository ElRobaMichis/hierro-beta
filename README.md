...
La versión **3.14.0** celebra lo que viene: al abrir un día, cada propuesta se revela al verla y «Subir carga» hace rodar el peso hasta el nuevo con destellos y una escala que sube. Registrar también se siente: las reps en reserva se eligen de un toque en la misma pantalla, mantener + o − acelera, los discos por lado llevan su color y llegar al tope del rango se anuncia en el momento. Consulta [la sección 3.14.0](docs/motion-sound-2026-09-23/README.md#3140--lo-que-viene-se-celebra).
