...
La versión **3.15.0** cuenta el cierre de la sesión en capítulos, como historias: cuánto más fuerte fuiste frente a la vez pasada, el cuerpo con los grupos que trabajaste encendiéndose uno a uno, tus récords, tu mejor serie de antes y de ahora en cada ejercicio, el peso movido con su objeto y tu racha. Cada capítulo tiene su animación y su sonido, avanza solo cada 7 segundos y se detiene en cuanto tocas; mantener pulsado lo sostiene y el botón de pausa lo congela para hacer captura. Todas las series quedan a un toque, en «Ver el detalle». Consulta [la sección 3.15.0](docs/motion-sound-2026-09-23/README.md#3150--el-cierre-en-capítulos).
